...
// Generated on: Nov 14 2024 16:14:16 IST (Nov 14 2024 10:44:16 UTC)
...
module RCA_N7(X, Y, Ci, S, Co);
  ...
  fulladder_7 \adder_stage[6].genblk1.FA (X[6], Y[6], w[5], S[6], Co);
endmodule
...
module HOERAA(X, Y, S, Co);
  ...
  assign S[5] = 1'b1;
  assign S[6] = 1'b1;
  RCA_N7 accurate_subadder(X[15:9], Y[15:9], Ci, S[15:9], Co);
  OAI21XL g80__3680(.A0 (n_0), .A1 (Ci), .B0 (n_1), .Y (S[8]));
  NAND3XL g81__1617(.A (X[7]), .B (Y[7]), .C (Ci), .Y (n_1));
  OR2XL g82__2802(.A (Y[7]), .B (X[7]), .Y (S[7]));
  NOR2XL g83__1705(.A (Y[8]), .B (X[8]), .Y (n_0));
  AND2X1 g84__5122(.A (X[8]), .B (Y[8]), .Y (Ci));
endmodule
