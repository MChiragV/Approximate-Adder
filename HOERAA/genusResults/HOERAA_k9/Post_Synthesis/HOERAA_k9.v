...
// Generated on: Nov 14 2024 16:32:44 IST (Nov 14 2024 11:02:44 UTC)
...
module RCA_N9(X, Y, Ci, S, Co);
  ...
  fulladder_10 \adder_stage[7].genblk1.FA (X[7], Y[7], w[6], S[7],
       w[7]);
  fulladder_9 \adder_stage[8].genblk1.FA (X[8], Y[8], w[7], S[8], Co);
endmodule
...
module HOERAA(X, Y, S, Co);
  ...
  assign S[3] = 1'b1;
  assign S[4] = 1'b1;
  RCA_N9 accurate_subadder(X[15:7], Y[15:7], Ci, S[15:7], Co);
  OAI21XL g80__2802(.A0 (n_0), .A1 (Ci), .B0 (n_1), .Y (S[6]));
  NAND3XL g81__1705(.A (X[5]), .B (Y[5]), .C (Ci), .Y (n_1));
  OR2XL g82__5122(.A (Y[5]), .B (X[5]), .Y (S[5]));
  NOR2XL g83__8246(.A (Y[6]), .B (X[6]), .Y (n_0));
  AND2X1 g84__7098(.A (X[6]), .B (Y[6]), .Y (Ci));
endmodule
